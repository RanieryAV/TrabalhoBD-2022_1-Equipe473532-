            ...
            while menu=="1" or menu=="2" or menu=="3" or menu=="4" or menu=="5" or menu=="6" or menu=="7":
                ...
                if menu=="1":
                    ...
                    with connection.cursor() as cursor:
                        ...
                        connection.commit();
                        print("\nInfo: Alteração do livro com ISBN antigo '{isbn_livro_pk_antiga}' feita com sucesso!\n").format(isbn_livro_pk_antiga=isbn_livro_pk_antiga)
                    print("\n")
                elif menu=="2":
                    ...
                    with connection.cursor() as cursor:
                        ...
                        connection.commit();
                        print("\nInfo: Alteração do autor com email antigo '{email_autor_pk_antiga}' feita com sucesso!\n").format(email_autor_pk_antiga=email_autor_pk_antiga)
                    print("\n")
                elif menu=="3":
                    ...
                    with connection.cursor() as cursor:
                        ...
                        connection.commit();
                        print("\nInfo: Alteração da categoria com codigo antigo '{codigo_categoria_pk_antiga}' feita com sucesso!\n").format(codigo_categoria_pk_antiga=codigo_categoria_pk_antiga)
                    print("\n")
                elif menu=="4":
                    ...
                    with connection.cursor() as cursor:
                        ...
                        connection.commit();
                        print("\nInfo: Alteração do curso com codigo antigo '{codigo_curso_pk_antiga}' feita com sucesso!\n").format(codigo_curso_pk_antiga=codigo_curso_pk_antiga)
                    print("\n")
                elif menu=="5":
